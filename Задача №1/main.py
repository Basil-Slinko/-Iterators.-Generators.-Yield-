...
class CountriesIterate:
  ...
  def __init__(self, path_json, list_names_and_links=list()):
    self.file = open(path_json)
    self.list_names_and_links = list_names_and_links
...
with open('country_links.txt', 'a') as country_links_file:
